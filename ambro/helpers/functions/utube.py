...
PATH = "./ambro/cache/ytsearch.json"
...
async def yt_search(amb):
    try:
        amb = urllib.parse.quote(amb)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={amb}"
        )
...
"""
async def yt_data(amb):
    params = {"format": "json", "url": amb}
