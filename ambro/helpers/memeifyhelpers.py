...
from wand.image import Image as ambimage

from .utils import _ambutils
...
async def amb_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def amb_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = ambimage(filename=picture_name)
    main_image.resize(
