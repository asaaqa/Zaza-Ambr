...
# Blacklist User for use Kyy-ambro
while 0 < 6:
    _BLACKLIST = get(
...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/9afc060ca553fb30ba101.jpg"
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/jookalem/Joo-ambro")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Joo-ambro")
...
# set blacklist_chats where you do not want ambro's features
...
KYY_TEKS_KUSTOM = os.environ.get("KYY_TEKS_KUSTOM", "I'am Using Joo-ambro✨")

# Untuk Mengubah Pesan Welcome
START_WELCOME = os.environ.get("START_WELCOME", None)

# Default .alive Name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Joo")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Joo-ambro")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/9afc060ca553fb30ba101.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/9afc060ca553fb30ba101.jpg"

# Default emoji help
EMOJI_HELP = os.environ.get("EMOJI_HELP") or "ރ"

# °Joo-ambro°
OWNER_URL = os.environ.get("OWNER_URL") or "https://t.me/ikhsanntarjo"
...
async def checking():
    gocheck = str(pybase64.b64decode("QG5vdHR1cmFyZWE="))[2:15]
    checker = str(pybase64.b64decode("QFByb2plY3RKb25p"))[2:16]
    checker2 = str(pybase64.b64decode("QEpvbmlTdXBwb3J0"))[2:16]
    try:
...
with bot:
    try:
        ...
        LOGS.info(
            "Join Support Group @JoniSupport and Channel @ProjectJoni to see the updates of ambro"
            "Don't Leave")
        quit(1)
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Joo-ambro v{BOT_VER} is back up and running!**\n\n"
...
try:
    from ambro.modules.sql_helper.globals import delgvar, gvarstatus
...
with bot:
    try:
        from ambro.modules.sql_helper.bot_blacklists import check_is_black_list
        from ambro.modules.sql_helper.bot_pms_sql import add_user_to_db, get_user_id
        from ambro.utils import reply_id
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                reply_pop_up_alert = f"Kamu Tidak Diizinkan, Ini ambro Milik {owner}"
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@Mlze1bot"):
                ...
                result = builder.article(
                    ...
                    thumb=InputWebDocument(
                        ...
                        "image/jpeg",
                        []),
                    text="**🥷 ᴊσσ-ᴜѕᴇʀвσт 🥷**\n➖➖➖➖➖➖➖➖➖➖\n✣ **ᴏᴡɴᴇʀ ʀᴇᴘᴏ :** [ᴊᴏᴏ](https://t.me/ikhsanntarjo)\n✣ **sᴜᴘᴘᴏʀᴛ :** @JoniSupport\n✣ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [ᴊσσ-υѕᴇʀвσт](https://github.com/Joo-ambro)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                ...
                result = builder.article(
                    title="🥷 ᴊσσ-ᴜѕᴇʀвσт 🥷",
                    description="Joo - ambro | Telethon",
                    url="https://t.me/Mlze1bot",
                    thumb=InputWebDocument(
                        ALIVE_LOGO,
                        0,
                    ...
                    buttons=[
                        [
                            ...
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/asaaq/Zaza-Ambro"),
                        ],
                    ],
                    link_preview=False,
                )
            await event.answer(
                [result], switch_pm="👥 ambro PORTAL", switch_pm_param="start"
            )
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                reply_pop_up_alert = (
                    f"Kamu Tidak Diizinkan, Ini ambro Milik {owner}"
                )
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
