...
class AmbUserBotClient(TelegramClient):
    def amb_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @asaaqali\
                                  \n\n--------بـدء تتبـع سجـل أمبرو بلاك AMBRO--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع أمبرو بلاك AMBRO--------"
                        ...
                        link = "[𐇮  الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/ASAAQALIO)"
                        text = (
                            "**✘ تقـريـر اشعـار أمبرو بلاك AMBRO ✘**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    ambub.add_event_handler(func, events.MessageEdited(**kwargs))
                ambub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  \n\nنسجل فقـط تقريـر الإشعـار وتـاريخـه ،\
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس \
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                                  \n\n- التقـريـر :\n{str(check.text)}\
                        ...
                        text = "**✘ تقـريـر اشعـار أمبرو بلاك AMBRO ✘**\n\n "
                        link = "[𐇮  الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/ASAAQALIO)"
            ...
            if edited is True:
                ambub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                ambub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
AmbUserBotClient.fast_download_file = download_file
AmbUserBotClient.fast_upload_file = upload_file
AmbUserBotClient.reload = restart_script
AmbUserBotClient.get_msg_link = get_message_link
AmbUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    AmbUserBotClient.send_message = send_message
    AmbUserBotClient.send_file = send_file
    AmbUserBotClient.edit_message = edit_message
