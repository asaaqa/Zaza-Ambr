...
async def hi(event):
    await edit_or_reply(
        event,
        "۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n\n**⎊ هـذه هي قائمة اوامـر سـورس الامبــراطور **\n\n⎊ `.الامر1` ◂ اوامر الأدمن\n⎊ `.الامر2` ◂ اوامر المجموعة\n⎊ `.م3` ◂ اوامر الترحيب\n⎊ `.م4` ◂ اوامر الردود\n⎊ `.م5` ◂ اوامر الترفيه\n⎊ `.م6` ◂ اوامر حماية الخاص\n⎊ `.م7` ◂ اوامر الاذاعه و الكشف \n⎊ `.م8` ◂ اوامر البوت \n⎊ `.م9` ◂ اوامر المنع والترجمه\n⎊ `.م10` ◂ اوامر التلكراف و النطق\n⎊ `.م11` ◂ اوامر التحميل\n⎊ `.م12` ◂ اوامر التكرار\n⎊ `.م13` ◂ اوامر الانتحال والتقليد\n⎊ `.م14` ◂ اوامر الوقتي \n⎊ `.م15` ◂ اوامر الذاتيه والاضافه\n⎊ `.م16` ◂ اوامر البروفايل\n⎊ `.م17` ◂ اوامر الأكسترا\n⎊ `.م18` ◂ التاك و الملفات\n⎊ `.م19` ◂ اوامر الصيغ\n⎊ `.م20` ◂ اوامر التسلية\n⎊ `.م21` ◂ اوامر التحكم\n⎊ `.م22` ◂ اوامر حماية المجموعة\n⎊ `.م23` ◂ اوامر لعبة البنك و الخطوط\n⎊ `.م24` ◂ اوامر الرفع و النسب للتسلية\n⎊ `.م25` ◂ اوامر تجميع النقاط \n⎊ `.م26` ◂ اوامر الصيد و الالعاب\n⎊ `.م27` ◂ اوامر الافتارات و البصمات\n⎊ `.م28` ◂ اوامر لافلام و المسرحيات\n⎊ `.م29` ◂ اوامر القرآن الكريم \n⎊ `.م30` ◂ اوامر تحديثات السورس \n۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n**⌯︙[┈┉━｢ ᥉᥆υᖇᥴᥱڪٱيدّو ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢  🕷 ｣━┅┈](t.me/ASAAQALO)**",
        link_preview=False,
    )
...
async def we(event):
    await edit_or_reply(
        event,
        "۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n\n• اوامر التحكم تتيح لمستخدم اخر ان يستخدم اوامر تنصيبك وهو غير منصب الامبــراطور  حيث سيصبح متحكم في اوامر تنصيبك يرجى الانتباه من انه سيحصل على صلاحيات الاوامر وقد يسبب خطورة لك اذا كنت لا تثق في المستخدم الذي اضفته. \n\n\n`.التحكم` تفعيل/تعطيل\n• تستخدم هذه الميزة لتفعيل/لتعطيل خاصية التحكم بأوامر تنصيبك للمستخدمين الذين أضفتهم في قائمة المتحكمين\n\n`.المتحكمين`\n• لعرض المستخدمين الذين اضفتهم الى قائمة المستخدمين المتحكمين\n\n`.اضف متحكم`\n• بالرد على المستخدم لأضافته متحكم في تنصيب الامبــراطور  الخاص بك\n\n`.ازالة متحكم`\n• بالرد على المستخدم لازالته من قائمة المتحكمين\n۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n**⌯︙ [┈┉━｢ ᥉᥆υᖇᥴᥱڪٱيدّو ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢  🕷 ｣━┅┈](t.me/ASAAQALO)**",
        link_preview=False,
    )
...
async def ae(event):
    await edit_or_reply(
        event,
        "۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n\n⎊ اوامر لعبة البنك و الخطوط\n\n⎊ قائمة اوامر بنك سورس الامبــراطور \n\n⎊ لأنشاء حساب بنكي\n⎊ اكتب(`.انشاء حساب بنك الامبــراطور `)\n\n① (`.استثمار` + المبلغ) \n◂ مثال :(`.استثمار 100`)\n② (`.حظ` + المبلغ)\n◂ مثال : (`.حظ 100`)\n③ (`.راتب`)\n④ (`.كنز`)\n⑤ (`.بخشيش`)\n⑥ (`.فلوسي`) | لرؤية فلوسك\n⑦ (`.بنكي` او `.مصرفي`) | برؤية حسابك\n⑧ (`.مسح حسابي`) | لحذف حسابك البنكي\n\n⎊ قائمة اوامر خطوط سورس الامبــراطور \n\n⎊ لتفعيل الخط الغامق\n⎊ اكتب (`.خط الغامق`)\n⎊ لألغاء الخط الغامق اكتب الامر مرة ثانية\n\n⎊ لتفعيل خط الرمز\n⎊ اكتب (`.خط الرمز`)\n⎊ لألغاء خط الرمز اكتب الامر مرة ثانية\n\n⎊ لتفعيل الزخرفة العربية\n⎊ اكتب ◂ `.تفعيل الزخرفة الانجليزية`\n⎊ للتعطيل اكتب ◂ `.تعطيل الزخرفة الانجليزية`\n۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞",
        link_preview=False,
    )
...
async def ae(event):
    await edit_or_reply(
        event,
        "⎊ `.القران الكريم` \n⎊ `.آيه نصيه` \n⎊ `.آيه قصيره` \n\n⎊ `.سوره للقارئ الشيخ عبدالباسط عبدالصمد` \n⎊ `.سوره للقارئ الشيخ ياسر الدوسري` \n⎊ `.سوره للقارئ الشيخ محمد صديق المنشاوي` \n⎊ `.سوره للقارئ الشيخ عبدالرحمن السديس` \n⎊ `.سوره للقارئ الشيخ مشاري العفاسي` \n⎊ `.سوره للقارئ الشيخ احمد العجمي` \n⎊ `.سوره للقارئ الشيخ ناصر القطامي` \n⎊ `.سوره للقارئ الشيخ محمد جبريل` \n⎊ `.سوره للقارئ الطبيب احمد نعينع` \n⎊ `.سوره للقارئ الشيخ ابراهيم الاخضر` ",
        link_preview=False,
    )
...
async def ae(event):
    await edit_or_reply(
        event,
        "۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞\n\n⎊ قائمة تحديثات سورس الامبــراطور \n\n⎊اوامر عمل حساب gmail وهمي\n⎊ اكتب ◂ `.ايميل وهمي` \n\n⎊ تيلثون الامبــراطور  الذكاء الاصطناعي\n⎊ اكتب (`.os` + اي شئ تريدة)\n⎊ مثال ◂ `.os كم عدد سكان مصر`\n\n⎊ سورس الامبــراطور  اختراق كود تيرمكس\n⎊ اكتب (`.هاك`)\n\n⎊ سورس الامبــراطور  فحص فيزات\n⎊ لجلب فيز اكتب ◂ (`.فيزا`)\n⎊ لفحص فيزا اعمل ريب على الفيزا\n⎊ واكتب (`.cc`)\n\n⎊ لجلب معلومات عن حساب github\n⎊ اكتب ( `.كيثهاب` + يوزر الحساب ) \n\n⎊ اوامر ارسال رسالة موقوتة\n⎊ اكتب ( `.مؤقت` + الرسالة + عدد الثواني ) \n⎊ مثال (`.مؤقت اهلا `10) \n\n⎊ اوامر الكتم ◂ لكتم شخص في الخاص\n⎊ للتفعيل اكتب ◂ `.كتم`\n⎊ للتعطيل اكتب ◂ `.الغاء كتم`\n\n⎊ اوامر تمبلر\n⎊ `.تمبلريه` `.البايو` `.الزغرفة` `.الاختصارات` \n\n⎊ لعرض اخر تحديثات السورس \n⎊ اكتب ◂ `.التحديثات`\n۞ 𝐒𝐎𝗨𝐑𝐂𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 ۞",
        link_preview=False,
    )
